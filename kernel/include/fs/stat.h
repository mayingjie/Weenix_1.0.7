...
#define S_IFCHR         0x0100  /* character special , ex: terminal*/
#define S_IFDIR         0x0200 /* directory */
#define S_IFBLK         0x0400 /* block special , ex: deivde with block IO*/
#define S_IFREG         0x0800 /* regular */
#define S_IFLNK         0x1000 /* symlink , MC file or directory*/
