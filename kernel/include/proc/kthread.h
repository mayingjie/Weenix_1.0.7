...
typedef struct kthread {
		...
		/* MC
		get function alloc stack return char */
		...
		/* set to function lthread_create paprent process */ 
        struct proc    *kt_proc;        /* the thread's process */

		/* initial to zero, before cancellation */
        int             kt_cancelled;   /* 1 if this thread has been cancelled */
		/*MC
		 ktqueue_t
		 defined in kernel/include/proc/sched.h */
