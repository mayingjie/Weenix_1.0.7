...
proc_thread_exited(void *retval)
{
		...
		/* MC
		?? different retval need to do anything 
		may be in the future*/



		/* ?? exited thread means current proceses 
		i think yes  unless there are multiple processors*/
		KASSERT(curproc != NULL);
		/*exited_thread_proc = curthr-> kt_proc;*/
